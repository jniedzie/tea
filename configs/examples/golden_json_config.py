...
goldenJsons = {}
input_path_2016 = "../tea/data/golden_json/Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON.txt"
input_path_2017 = "../tea/data/golden_json/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt"
...
with open(input_path_2016) as f:
  goldenJsons["2016"] = json.load(f)

with open(input_path_2017) as f:
  goldenJsons["2017"] = json.load(f)
