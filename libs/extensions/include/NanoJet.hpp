...
class NanoJet {
 public:
  ...
  float GetBtaggingScaleFactor(std::string workingPoint, std::string variant = "systematic");
  float GetPUJetIDScaleFactor(std::string name, std::string variant = "systematic");
