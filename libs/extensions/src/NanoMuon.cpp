...
map<string,float> NanoMuon::GetScaleFactor(string nameID, string nameIso, string nameReco, string year) {
  ...
  map<string,float> isoSF = scaleFactorsManager.GetMuonScaleFactor(nameIso, fabs(GetEta()), GetPt());
